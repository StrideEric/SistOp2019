...
#Agregar a la simulación anterior la posibilidad de cargar procesos en las particiones libres. El programa debe permitir
#ingresar procesos mientras haya memoria libre para asignar, por cada proceso ingresar (Id de proceso y tamaño del proceso)
#. La tabla de particiones deberá contener (Id de partición, dirección de comienzo de partición, tamaño de la partición,
#stado de la partición, id de proceso asignado a la partición, fragmentación interna). Mostrar por cada proceso ingresado
